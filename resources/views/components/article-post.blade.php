<div class="col-lg-6 col-md-6 mb-5">
    <div class="blog-item">
        ...
        <div class="blog-item-content bg-white p-5">
            ...
            <h3 class="mt-3 mb-3"><a href="{{route('articles.show',['article'=>$slug])}}">{{$title}}</a></h3>
            <p class="mb-4">{{$description}}</p>
            <a href="{{route('articles.show',['article'=>$slug])}}" class="btn btn-small btn-main btn-round-full">Learn More</a>
        </div>
    </div>
</div>