        ...
        <div class="row">
            <div class="col-lg-9 col-md-10">
                <div class="block">
                    ...
                    <h1 class="animated fadeInUp mb-5">{{__('messages.Our work is presentation of our capabilities')}}</h1>
...
<x-testimonial-wrapper>
    ...
    <x-testimonial
        testimonial="Quam maiores perspiciatis temporibus odio reiciendis error alias debitis atque consequuntur natus iusto recusandae numquam corrupti facilis blanditiis"
        name="Thomas Johnson"
        designation="Excutive Director,themefisher" />
    <x-testimonial
        testimonial="Consectetur adipisicing elit. Quam maiores perspiciatis temporibus odio reiciendis error alias debitis atque consequuntur natus iusto recusandae."
        name="Mickel Hussy"
        designation="Executive Director, themefisher" />

    <x-testimonial
        testimonial="Quam maiores perspiciatis temporibus odio reiciendis error alias debitis atque consequuntur natus iusto recusandae numquam corrupti."
        name="James Watson"
        designation="Executive Director, themefisher" />
