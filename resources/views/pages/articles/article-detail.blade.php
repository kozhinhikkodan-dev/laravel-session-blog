				...
				<div class="row">
					<div class="col-lg-12 mb-5">
						<div class="single-blog-item">
							<img src="{{asset('images/blog/2.jpg')}}" alt="" class="img-fluid rounded">
			...
			<div class="col-lg-4">
				<div class="sidebar-wrap">
					...
					<div class="sidebar-widget card border-0 mb-3">
						<img src="{{asset('images/blog/blog-author.jpg')}}" alt="" class="img-fluid">
					...
					<div class="sidebar-widget latest-post card border-0 p-4 mb-3">
						...
						<div class="media border-bottom py-3">
							<a href="#"><img class="mr-4" src="{{asset('images/blog/bt-3.jpg')}}" alt=""></a>
						...
						<div class="media border-bottom py-3">
							<a href="#"><img class="mr-4" src="{{asset('images/blog/bt-2.jpg')}}" alt=""></a>
							<div class="media-body">
						...
						<div class="media py-3">
							<a href="#"><img class="mr-4" src="{{asset('images/blog/bt-1.jpg')}}" alt=""></a>
							<div class="media-body">
					...
					<form id="" class="00" method="post" action="{{route('articles.force.destroy',['article'=>$article->id])}}">
						@csrf
						@method('DELETE')
