	...
	<div class="col-lg-6 col-md-6 mb-5">
		<div class="blog-item">
			...
			<div class="blog-item-content bg-white p-5">
				...
				<h3 class="mt-3 mb-3"><a href="{{route('blogs.show',['blog'=>1])}}">Improve design with typography?</a></h3>
				<p class="mb-4">Non illo quas blanditiis repellendus laboriosam minima animi. Consectetur accusantium pariatur repudiandae!</p>

				<a href="{{route('blogs.show',['blog'=>1])}}" class="btn btn-small btn-main btn-round-full">Learn More</a>
			</div>
		</div>
	</div>
	...
	<div class="col-lg-6 col-md-6 mb-5">
		<div class="blog-item">
			...
			<div class="blog-item-content bg-white p-5">
				...
				<h3 class="mt-3 mb-3"><a href="{{route('blogs.show',['blog'=>1])}}">Interactivity connect consumer</a></h3>
				<p class="mb-4">Non illo quas blanditiis repellendus laboriosam minima animi. Consectetur accusantium pariatur repudiandae!</p>
	...
	<div class="col-lg-6 col-md-6 mb-5">
		<div class="blog-item">
			...
			<div class="blog-item-content bg-white p-5">
				...
				<h3 class="mt-3 mb-3"><a href="{{route('blogs.show',['blog'=>1])}}">Marketing Strategy to bring more affect</a></h3>
				<p class="mb-4">Non illo quas blanditiis repellendus laboriosam minima animi. Consectetur accusantium pariatur repudiandae!</p>
